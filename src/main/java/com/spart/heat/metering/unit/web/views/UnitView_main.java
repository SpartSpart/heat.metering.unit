...
//import ru.spart.heat.metering.unit.web.model.UnitInfo;
...
//
//    @Autowired
//    public UnitView(UnitService unitService, UserService userService){
//
...
//                LocalDate unitDate = unitInfo.getAr_date().toLocalDate();
...
//        return unitService.getUnitDayInfo(unitId);
//    }
//
//    private List<UnitInfo> getUnitHourInfo(int unitId){
//        return unitService.getUnitHourInfo(unitId);
//    }
//
//
//}
